...
SUBROUTINE INV_TRANS_with_proc(PSPVOR,PSPDIV,PSPSCALAR,PSPSC3A,PSPSC3B,PSPSC2,&
 & FSPGL_PROC,&
 & LDSCDERS,LDVORGP,LDDIVGP,LDUVDER,LDLATLON,KPROMA,KVSETUV,KVSETSC,KRESOL,&
 & KVSETSC3A,KVSETSC3B,KVSETSC2,&
 & PGP,PGPUV,PGP3A,PGP3B,PGP2)
...
USE SET_RESOL_MOD     ,ONLY : SET_RESOL
USE INV_TRANS_CTL_MOD ,ONLY : INV_TRANS_CTL_with_proc
USE ABORT_TRANS_MOD   ,ONLY : ABORT_TRANS
USE YOMHOOK           ,ONLY : LHOOK,   DR_HOOK, JPHOOK
...
CALL INV_TRANS_CTL_with_proc(IF_UV_G,IF_SCALARS_G,IF_GP,IF_FS,IF_OUT_LT,&
 & IF_UV,IF_SCALARS,IF_SCDERS,&
...
END SUBROUTINE INV_TRANS_with_proc
